...
export class ProveedoresService {
  ...
  private baseUrl = 'https://conex-api-backend.duckdns.org/proveedores/'; 
  private categoriaUrl = 'https://conex-api-backend.duckdns.org/categorias/'; // 🆕 URL para categorías
